<!-- https://github.com/madi-nuralin/material/blob/v3_1_0-1/templates/frontend/objects/article_details.tpl -->
 {if !$heading}
				...
				<dl class="divide-y divide-slate-200 dark:divide-slate-800 my-0">
					...
					{if $publication->getLocalizedData('abstract')}
						<div class="px-4 py-6 sm:grid sm:grid-cols-3 sm:gap-4 sm:px-0">
							...
							<dd class="material-article-abstract-override mt-1 _text-sm/6 text-slate-400 sm:col-span-2 sm:mt-0">
